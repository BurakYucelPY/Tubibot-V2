...
export const slashCommands: SlashCommand[] = [
  ...
  {
    name: "clear",
    description: "Mevcut sohbeti temizle",
    icon: <Trash2Icon className="size-3.5" />,
    action: "clear",
  },
  {
    name: "rename",
    description: "Mevcut sohbeti yeniden adlandır",
    icon: <PenLineIcon className="size-3.5" />,
    action: "rename",
  },
  {
    name: "model",
    description: "Yapay zeka modelini değiştir",
    icon: <ListIcon className="size-3.5" />,
    action: "model",
  },
  {
    name: "theme",
    description: "Koyu/açık temayı değiştir",
    icon: <PaletteIcon className="size-3.5" />,
    action: "theme",
  },
  {
    name: "delete",
    description: "Mevcut sohbeti sil",
    icon: <XIcon className="size-3.5" />,
    action: "delete",
  },
  {
    name: "purge",
    description: "Tüm sohbetleri sil",
